function gwtproject(){
  ...
  gwtproject.__installRunAsyncCode = function(){
  }
  ;
  ...
  ;
  gwtproject.__gwt_isKnownPropertyValue = function(){
    return false;
  }
  ;
  gwtproject.__gwt_getMetaProperty = function(){
    return null;
  }
  ;
  ...
  gwtproject.__moduleStartupDone = function(permProps){
    var oldBindings = activeModules['gwtproject'].bindings;
    activeModules['gwtproject'].bindings = function(){
      var props = oldBindings?oldBindings():{};
      var embeddedProps = permProps[gwtproject.__softPermutationId];
  ...
  function installScript(filename){
    ...
    function installCode(code_0){
      ...
      script.src = code_0;
      if (gwtproject.__errFn) {
        script.onerror = function(){
          gwtproject.__errFn('gwtproject', new Error('Failed to load ' + code_0));
        }
        ;
      }
  ...
  function getCompiledCodeFilename(){
    ...
    var strongName;
    try {
      unflattenKeylistIntoAnswers(['safari'], '23BC4CEAFD806953FF63C5357FCBE8DE');
      unflattenKeylistIntoAnswers(['gecko1_8'], 'BDDF8480CAB2C6BB1152D32FACE6B56D');
  ...
  if ($wnd_0) {
    ...
    $wnd_0.__gwt_activeModules['gwtproject'].canRedirect = devModePermitted;
    ...
    if (devModePermitted && supportsSessionStorage()) {
      var devModeKey = '__gwtDevModeHook:gwtproject';
